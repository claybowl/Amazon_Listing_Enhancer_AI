...
const ApiKeyManager: React.FC<ApiKeyManagerProps> = ({ onApiKeyChange, hasApiKey }) => {
  ...
  return (
    <div className="p-4 bg-slate-700/50 rounded-lg mb-6 border border-yellow-500/50">
      <div className="flex items-center mb-3">
        ...
        <h3 className="text-lg font-medium text-yellow-400">Gemini API Key Required</h3>
      </div>

      <p className="text-slate-300 text-sm mb-4">
        To use this application, you need to provide your Gemini API key. Your key will be stored locally in your
